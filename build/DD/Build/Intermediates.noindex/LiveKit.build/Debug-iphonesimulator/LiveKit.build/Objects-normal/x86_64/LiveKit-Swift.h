...
/// See <code>AudioManager/isVoiceProcessingBypassed</code> for device-side VPIO controls.
...
/// See <code>AudioManager/isVoiceProcessingAGCEnabled</code> for device-side VPIO controls.
...
- (nonnull instancetype)initWithEchoCancellation:(BOOL)echoCancellation autoGainControl:(BOOL)autoGainControl noiseSuppression:(BOOL)noiseSuppression highpassFilter:(BOOL)highpassFilter typingNoiseDetection:(BOOL)typingNoiseDetection OBJC_DESIGNATED_INITIALIZER;
...
- (nonnull instancetype)initWithSharedKey:(BOOL)sharedKey ratchetSalt:(NSData * _Nonnull)ratchetSalt ratchetWindowSize:(int32_t)ratchetWindowSize uncryptedMagicBytes:(NSData * _Nonnull)uncryptedMagicBytes failureTolerance:(int32_t)failureTolerance keyRingSize:(int32_t)keyRingSize OBJC_DESIGNATED_INITIALIZER;
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, readonly) NSUInteger hash;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
+ (BOOL)ensureDeviceAccessSyncFor:(NSSet<AVMediaType> * _Nonnull)types SWIFT_WARN_UNUSED_RESULT;
@end
...
/// <code>performRpcWithDestinationIdentity:method:payload:responseTimeout:completionHandler:</code>.
...
- (void)performRpcWithDestinationIdentity:(ParticipantIdentity * _Nonnull)destinationIdentity method:(NSString * _Nonnull)method payload:(NSString * _Nonnull)payload responseTimeout:(NSTimeInterval)responseTimeout completionHandler:(void (^ _Nonnull)(NSString * _Nullable, NSError * _Nullable))completionHandler;
